...
function giveRightToVote(address voter) public {
    ...
    // are called incorrectly. But watch out, this
    ...
    function delegate(address to) public {
        ...
        // because if they run slow they might
        // need more gas than is avialable in a block.
        // In this case, the delegation will not be executed,
        // but in the other situations, such loops might
        // cause a contract to get "stuck" completely.
        while (voters[to].delegate != address(0)) {
            to = voters[to].delegate;

            // We found a loop in the delegation, no allowed.
            require(to != msg.sender);
        }
